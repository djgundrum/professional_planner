                    ...
                    <div id="calendarControlsBottomContent" className="scrollbox-content">
                        {
                            ...
                            <>
                                <div onClick={this.toggleCalendars}>
                                    <CalendarControlsDropdown title="Employees" propShow={this.state.showCalendars} section="first"/>
                                </div>
                                {this.state.showCalendars && <EmployeeList updateCalendars={this.props.updateCalendars} activeCalendars={this.props.activeCalendars} view={this.props.view}/>}

                                <div onClick={this.toggleTeamSchedules}>
                                    <CalendarControlsDropdown title="Meeting Blocks" propShow={this.state.showTeamSchedules}/>
                                </div>
                                {this.state.showTeamSchedules && <MeetingList updateTeamSchedule={this.props.updateTeamSchedule} activeTeamSchedule={this.props.activeTeamSchedule} view={this.props.view}/>}
